...
| 46 | Sprint 30 auth/onboarding UI | ✅ PASS | ✅ ALL state docs | ✅ ALL PASS | ❌ staging | AuthService, ApiClient tokenProvider, LoginScreen, AuthGate routing, 42 Flutter tests, 192 total |
